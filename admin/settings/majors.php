...
// 3. ดึงข้อมูลสาขาทั้งหมดมาแสดงในตาราง
...
<head>
    ...
    <style>
        ...
        /* 1. จัดระเบียบ Body ให้ Footer อยู่ล่างสุดเสมอ (Sticky Footer logic) */
        body {
            display: flex;
...
<body>
                            ...
                            <form id="majorForm" action="<?php echo $edit_mode ? '../settings/update_major.php' : '../settings/add_major.php'; ?>" method="post">
                                ...
                                <div class="row align-items-center g-3">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <?php if ($edit_mode): ?>
                                            <a href="../settings/majors.php" class="btn-link ms-2 text-decoration-none text-muted">ยกเลิก</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </form>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // --- ส่วนจัดการ Disable ปุ่มบันทึกจนกว่าจะมีการแก้ไข ---
