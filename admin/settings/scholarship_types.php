...
<head>
    ...
    <style>
        /* --- เพิ่มเติมเพื่อแก้ปัญหา 2 ข้อที่คุณแจ้ง --- */
        ...
        .dashboard-container {
            flex: 1 0 auto; /* ดันเนื้อหาให้ขยายพื้นที่เพื่อให้ footer อยู่ล่างสุดเสมอ */
        }
...
<body>
    ...
    <div class="container-fluid dashboard-container">
        <div class="row g-4">
            <!-- Sidebar Column (20% like admin.php) -->
            <div class="col-12 col-sidebar-20">
                <?php include '../../include/sidebar.php'; ?>
            </div>

            <!-- Main Content Column (80% like admin.php) -->
