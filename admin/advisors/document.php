...
<head>
    ...
    <style>
        /* ปรับแต่งปุ่มดาวน์โหลดให้สวยงาม */
        .btn-pdf-download {
        ...
        /* ปรับส่วนหนังสือรับรองให้รองรับชื่อสาขาวิชายาวๆ ในบรรทัดเดียว */
        .cert-text-paragraph {
            line-height: 2.5;
            text-align: justify;
        }
        ...
        .inline-readonly-field {
            ...
            color: #003b6f;
            padding: 0 10px;
            white-space: nowrap; /* ป้องกันการขึ้นบรรทัดใหม่ภายในช่อง */
            overflow: hidden;
    ...
    <div class="container py-5">
        <div class="app-form-container mx-auto">
            ...
            <form action="../scores/save_score.php" method="POST" class="scoring-panel mt-5">
                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        <textarea name="comment" id="scoreComment" class="form-control w-100 h-100" rows="4" placeholder="เสนอแนะเพิ่มเติม"></textarea>
                    </div>
