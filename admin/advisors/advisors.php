...
// --- 3. ดึงข้อมูลอาจารย์ที่ปรึกษาทั้งหมด (tc_type = 4) มาแสดงในตาราง ---
...
<body>
                        ...
                        <form id="advisorForm" action="<?php echo $edit_mode ? '../advisors/update_advisor.php' : '../advisors/add_advisor.php'; ?>" method="post">
                            ...
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-auto">
                                    ...
                                    <?php if ($edit_mode): ?>
                                        <a href="../advisors/advisors.php" class="btn-link ms-2 text-decoration-none text-muted">ยกเลิก</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // --- ส่วนจัดการ Disable ปุ่มบันทึกและตรวจสอบชื่อซ้ำ ---
