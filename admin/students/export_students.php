...
// ดึงข้อมูลนักศึกษา
$sql_export = "SELECT s.st_code, s.st_firstname, s.st_lastname, p.g_program, s.st_activate
               FROM tb_student s
...
<head>
    ...
    <style>
        th { background-color: #3b7ddd; color: white; border: 0.5pt solid #000; }
            ...
            <?php while($row = mysqli_fetch_assoc($result)): ?>
                <tr>
                    ...
                    <td style="text-align: center;">
                        <?php echo ($row['st_activate'] == 1) ? "อนุมัติแล้ว" : "รอดำเนินการ"; ?>
                    </td>
                </tr>
            <?php endwhile; ?>
        </tbody>
