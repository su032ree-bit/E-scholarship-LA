...
// ดึงรหัสนักศึกษาที่ถูกระงับอยู่แล้วในฐานข้อมูลเพื่อนำไปเช็กซ้ำ
...
<body class="d-flex flex-column min-vh-100">
                ...
                <main class="main-content shadow-sm">
                    ...
                    <form action="../admin/students/save_suspended.php" id="suspendedForm" method="post">
                        ...
                        <div class="d-flex justify-content-end mt-5 pt-3 border-top">
                            <button type="submit" id="submit-btn" class="btn btn-save" disabled>บันทึก</button>
                        </div>
                    </form>
                </main>
            </div>
    ...
    <!-- Template สำหรับแถวใหม่ (ใช้ JS Clone) -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ดึงข้อมูลรายชื่อที่มีอยู่แล้วจาก PHP เข้ามาใน JS
        const existingIds = <?php echo json_encode($existing_ids); ?>;

        // ฟังก์ชันตรวจสอบความถูกต้องของข้อมูลทั้งหมด
        ...
        addRow(); // เพิ่มแถวแรกเมื่อหน้าโหลด
