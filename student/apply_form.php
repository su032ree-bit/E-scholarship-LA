...
<head>
    ...
    <title>กรอกข้อมูลสมัครทุน - <?php echo htmlspecialchars($student['firstname']); ?></title>
...
<body class="bg-light">
    ...
    <div class="container py-4">
        <div class="app-form-container mx-auto">
            ...
            <ul class="nav-tabs-app">
                <li class="nav-item"><a href="apply_form.php" class="nav-link-custom active">ข้อมูลส่วนตัว</a></li>
            ...
            <form action="" method="POST" id="personalForm" class="px-2">
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-sm-9">
                        <input type="date" name="st_birthday" id="st_birthday" class="form-control" value="<?php echo $student['dob']; ?>" required onclick="this.showPicker()">
                    </div>
                </div>
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-sm-9 d-flex align-items-center gap-2">
                        <input type="number" name="st_age" class="form-control" style="max-width: 100px;" value="<?php echo $student['age']; ?>" required>
                        <span>ปี</span>
                    </div>
                </div>
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="st_address1" class="form-control" value="<?php echo htmlspecialchars($student['address1']); ?>" required>
                    </div>
                </div>
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="st_address2" class="form-control" value="<?php echo htmlspecialchars($student['address2']); ?>" required>
                    </div>
                </div>
                ...
                <div class="row mb-3 align-items-start">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="st_tel1" id="st_tel1" class="form-control" value="<?php echo htmlspecialchars($student['tel1']); ?>" required maxlength="10">
                        <div id="tel-error" class="tel-error-feedback">กรุณากรอกเบอร์โทรศัพท์ให้ถูกต้อง (เลข 10 หลัก เริ่มด้วย 0)</div>
                    </div>
                </div>
                ...
                <div class="row mb-4 align-items-center">
                    ...
                    <div class="col-sm-9">
                        <input type="email" name="st_email" class="form-control bg-light" value="<?php echo htmlspecialchars($student['email']); ?>" readonly>
                    </div>
                </div>
    ...
    <script>
        ...
        // --- ส่วนตรวจสอบเบอร์โทรศัพท์และควบคุมปุ่มถัดไป ---
